          ...
          <div className="space-y-6 text-gray-700">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-1">
                ...
                <li>LinkedIn profile data (when you authenticate via LinkedIn)</li>
                <li>Professional credentials and certifications</li>
              </ul>
              
              <h3 className="text-lg font-medium text-gray-800 mb-2 mt-4">Business Information</h3>
              <ul className="list-disc pl-6 space-y-1">
                <li>RFQ (Request for Quote) details and requirements</li>
                <li>Supplier capabilities and offerings</li>
                <li>Communication history and messages</li>
                <li>Transaction and pricing information</li>
              </ul>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li><strong>Platform Services:</strong> To provide and maintain our sourcing platform</li>
                <li><strong>Communication:</strong> To send you updates, notifications, and responses to inquiries</li>
                <li><strong>Business Matching:</strong> To connect buyers with relevant suppliers</li>
                <li><strong>Verification:</strong> To verify business credentials and LinkedIn profiles</li>
            ...
            <section>
              ...
              <p>
                ...
                with legal obligations. Business transaction data may be retained for up to 7 years for accounting 
                and legal purposes. You may request deletion of your account at any time.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li><strong>LinkedIn:</strong> For authentication and profile verification</li>
                <li><strong>Cloud Providers:</strong> For hosting and infrastructure (encrypted)</li>
                <li><strong>Analytics:</strong> For platform improvement (anonymized data)</li>
                <li><strong>Payment Processors:</strong> For transaction processing (if applicable)</li>
              </ul>
            </section>
            ...
            <section className="border-t pt-6 mt-8">
              <h2 className="text-xl font-semibold text-gray-900 mb-3">GDPR & CCPA Compliance</h2>
              <p>
